...
public class Juego extends Frame implements MouseListener
{
        ...
        if(matriz[0][fila]==0){
            if(matriz[im-1][fila]==0){
                ...
                if(encontradaPrioridad(4, c, fila)!=-2){
                    hacer=true;ig=c;jg=encontradaPrioridad(4, c, fila);
                }
                if(ganador==true){
                    Mensaje dig = new Mensaje(this,"ganador pc");
    ...
    private void revision(int rev, int i, int j){
        //las variables son solo comprobantes, los que tienen r son de horizontal y vertical y los que tienen D son diagonales.
        int ar=0,br=0,cr=0,dr=0,aD=0,bD=0,cD=0,dD=0,aR=0,bR=0,cR=0,dR=0,eR=0,fR=0; 
        if((j+3)<jm){
        ...
        //como se suman los nùmeros y cada jugador tiene numeros diferente, pregunta si hay un multiplo de 4 de su propio numero
        //si hay entonces ya tiene 4
        if( ( ((ar)==4*rev)==true ) ||(((br)==4*rev)==true)  ||(((cr)==4*rev)==true)||(((dr)==4*rev)==true)||(((aD)==4*rev)==true)||(((bD)==4*rev)==true)||(((cD)==4*rev)==true)||
        (((dD)==4*rev)==true)  ||(((aR)==4*rev)==true) ||(((bR)==4*rev)==true) ||(((cR)==4*rev)==true) ||(((dR)==4*rev)==true) 
    ...
    protected int encontradaPrioridad(int rev1, int i1, int j1){
        ...
        if((encontrado==false)&&(((i1+2)<im)&&((i1-1)>-1))){
            if((((matriz[i1+1][j1] +matriz[i1+2][j1] +rev1)==3*rev1)&&(matriz[i1-1][j1] ==0))&&(encontrado==false)){
                res=j1;
                encontrado=true;
            }
        }
        ...
        if((encontrado==false)&&(((j1+3)<jm)&&((i1-3)>-1))){
            if((((matriz[i1-3][j1+3] +matriz[i1-2][j1+2] +rev1)==3*rev1)&&(matriz[i1-1][j1+1] ==0)&&(matriz[i1][j1+1] !=0))&&(encontrado==false)){
                res=j1+1;
                encontrado=true;
            }

            if((((matriz[i1-3][j1+3] +matriz[i1-1][j1+1] +rev1)==3*rev1)&&(matriz[i1-2][j1+2] ==0)&&(matriz[i1-1][j1+2] !=0))&&(encontrado==false)){
                res=j1+2;
                encontrado=true;
            }        
        ...
        if((encontrado==false)&&(((j1+3)<jm)&&((i1+3)<im))){
            if((((matriz[i1+3][j1+3] +matriz[i1+2][j1+2] +rev1)==3*rev1)&&(matriz[i1+1][j1+1] ==0)&&(matriz[i1+2][j1+1] !=0))&&(encontrado==false)){
                res=j1+1;
                encontrado=true;
            }

            if((((matriz[i1+3][j1+3] +matriz[i1+1][j1+1] +rev1)==3*rev1)&&(matriz[i1+2][j1+2] ==0)&&(matriz[i1+3][j1+2] !=0))&&(encontrado==false)){
                res=j1+2;
                encontrado=true;
            }        
        ...
        if(((j1+3)<jm)&&((i1-1)>-1)){
            if((matriz[i1-1][j1+1] ==rev1)&&(matriz[i1-1][j1+2] ==rev1)&&(matriz[i1-1][j1+3] ==rev1)){
                res=j1;
                encontrado=true;
            }
        }
        ...
        if(((j1+3)<jm)&&((i1-4)>-1)){
            if((matriz[i1-2][j1+1] ==rev1)&&(matriz[i1-3][j1+2] ==rev1)&&(matriz[i1-4][j1+3] ==rev1)){
                res=j1;
                encontrado=true;
            }
        }
        ...
        if(((j1+2)<jm)&&((j1-1)>-1)&&((i1-1)>-1)){
            if((matriz[i1-1][j1+1] ==rev1)&&(matriz[i1-1][j1+2] ==rev1)&&(matriz[i1-1][j1-1] ==rev1)){
                res=j1;
                encontrado=true;
            }
        }
